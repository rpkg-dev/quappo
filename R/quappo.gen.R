# DO NOT EDIT THIS FILE BY HAND! Instead edit the R Markdown source file `Rmd/quappo.Rmd` and run `pkgpurl::purl_rmd()`.
# See `README.md#r-markdown-format` for more information on the literate programming approach used applying the R Markdown format.

# quappo: Unofficial Helper Functions around Quarto
